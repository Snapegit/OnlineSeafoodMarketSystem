...
CREATE TABLE `shangpinxinxi`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1709783037108 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品信息' ROW_FORMAT = DYNAMIC;
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 1, 'admin', 'users', '管理员', 'ysogc37eukev7c57qf09fs0pa33mw1rt', '2024-03-07 10:38:03', '2026-02-14 17:54:26');
